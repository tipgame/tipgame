...
/*		IFBAMemberStatistic ifbaMemberStatistic = new IFBAMemberStatistic();
		...
		Embedded membersIFBA = new Embedded();
		membersIFBA.setImmediate(false);
		membersIFBA.setWidth("100%");
		membersIFBA.setHeight("100%");
		membersIFBA.setSource(new ThemeResource(
				"resources/statistics/membersIFBA.png"));
		membersIFBA.setType(1);
		membersIFBA.setMimeType("image/png");
		
		panel_1.addComponent(membersIFBA);
	}
