...
public class TeamStatistic extends CustomComponent {
	...
	private void setSeriesData(InvientCharts chart)
	{
		...
		while(iter.hasNext())
		{
	        ...
	        seriesData.setSeriesPoints(getPoints(seriesData, team.getPoints()));
	        chart.addSeries(seriesData);
	        foundTeams = true;
		}
		
		if (!foundTeams){
			XYSeries seriesData = new XYSeries("");
	        seriesData.setSeriesPoints(getPoints(seriesData, 0));
	        chart.addSeries(seriesData);
		}
	...
	private LinkedHashSet<XAxis> setXAxis()
	{
        ...
        xAxis.setTitle(new AxisTitle("Team"));
	...
	private LinkedHashSet<YAxis> setYAxis()
	{
		...
		yAxis.setTitle(new AxisTitle("Punkte: (Punktesumme/Anzahl der Spieler * Normierungsfaktor)"));
